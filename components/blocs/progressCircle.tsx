  ...
  return (
    ...
    <View style={[styles.container, { width: radius * 2, height: radius * 2 }]}>
      ...
      <>
        ...
        <View style={{position:'absolute', borderWidth:1 , borderColor : 'black', width:10, top:99, left:-10}}/>
        <View style={{position:'absolute', borderWidth:1 , borderColor : 'black', width:10, top:99, right:-10}}/>
      </> 
      :
      <></>
    }
